        ...
        {!isRealScanning && (
          <div className="grid grid-cols-2 gap-3 mb-4">
            <button
              ...
              className="py-3 bg-green-600 dark:bg-green-700 text-white rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors font-semibold"
            >
              ✓ Demo
            </button>
            <button
              onClick={startRealScanning}
              className="py-3 bg-blue-600 dark:bg-blue-700 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors font-semibold"
            >
              📱 Escaneo Real
            </button>
          </div>
